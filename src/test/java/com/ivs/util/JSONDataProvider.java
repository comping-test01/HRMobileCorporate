...
public class JSONDataProvider {
  ...
  public static Object[][] fetchData(ITestContext context, Method method) throws Exception {
    Object rowID, description;
    Object[][] result;
    testCaseName = method.getClass().getTypeName();
    String className = method.getDeclaringClass().getName();
    dataFile = "src/main/resources/JSONInputs/" + className.substring(className.lastIndexOf(".") + 1) + ".json";
